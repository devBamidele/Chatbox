...
import 'package:chatbox/models/person.dart';
import 'package:chatbox/secret_keys.dart';
...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> gitLinkStream(
    ...
    try {
      final userCredential = await loginWithGitHub(code);
      User? user = userCredential.user;
  ...
  Future<void> handleGitUrlLaunch({
    required void Function(String) showSnackbar,
  }) async {
    Uri url = Uri.parse(
    ...
    if (await canLaunchUrl(url)) {
      ...
      showSnackbar('An error occurred. Try again later');
    }
  }
}
